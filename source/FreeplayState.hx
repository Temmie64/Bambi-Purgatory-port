...
class FreeplayState extends MusicBeatState
{
	...
	public function GoToActualFreeplay()
	{
		...
		missingText.setFormat(Paths.font("comic-sans.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		bottomText.setFormat(Paths.font("comic-sans.ttf"), size, FlxColor.WHITE, CENTER);
		...
		buttonTop.label.setFormat(Paths.font("comic-sans.ttf"), 24, FlxColor.BLACK, RIGHT);
		buttonTop.x = FlxG.width - buttonTop.width;
		add(buttonTop);

		searchText = new FlxText(975, 110, 100, "Search", 24);
		searchText.setFormat(Paths.font("comic-sans.ttf"), 24, FlxColor.BLACK);
		add(searchText);
